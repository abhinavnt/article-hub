...
import type { Article, ArticleFormData, Category } from "@/types/article";
...
export const EditArticle: React.FC = () => {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.category && !formData.newCategory) newErrors.category = "Category is required";
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent ${errors.description ? "border-red-500" : ""
                                }`}
                            required
                        />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={10}
                            className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent ${errors.content ? "border-red-500" : ""
                                }`}
                            required
                        />
                    ...
                    <div>
                        ...
                        />
                        {formData.image && <p className="mt-1 text-sm text-gray-600">Selected file: {formData.image.name}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className={`w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent ${errors.category ? "border-red-500" : ""
                                }`}
                            required
                        >
