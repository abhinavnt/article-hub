  ...
  return (
    <div className="space-y-2">
      ...
      {preview ? (
            ...
            <div className="space-y-3">
              <div className="flex justify-center">
                <div className={`p-3 rounded-full ${error ? "bg-red-100" : "bg-gray-100"}`}>
                  <Upload className={`w-5 h-5 ${error ? "text-red-500" : "text-gray-600"}`} />
                </div>
              </div>
        ...
        <div
          className={`relative border-2 border-dashed rounded-2xl p-12 text-center transition-all duration-200 cursor-pointer ${dragActive
              ? "border-black bg-gray-50 scale-[1.02]"
              : error
                ? "border-red-300 bg-red-50"
                : "border-gray-300 hover:border-gray-400 hover:bg-gray-50"
